...
export function CodiconAdd(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" {...props}>
      <path fill="currentColor" d="M14 7v1H8v6H7V8H1V7h6V1h1v6h6z"></path>
    </svg>
  )
}
      ...
      >
        ...
        <g mask="url(#bg-mask-0)">
          <path
            ...
            fillRule="evenodd"
            style={{ fill: '#8BCAE0' }}
            transform="translate(0 0)  rotate(0 21.5 21.790067598135053)"
            opacity="0.27"
...
export function CodiconSettings(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16" {...props}>
      <path
        fill="currentColor"
